            ...
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex justify-center gap-6 mb-8">
                    <a
                        ...
                        className="w-11 h-11 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 transition-colors text-white/70 hover:text-white"
                    ...
                    <a
                        ...
                        aria-label="note"
                    >
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 40 40">
